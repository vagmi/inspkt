...
//
// `maxFacilities` gates how many facilities an org can register;
// `apiCallsPerMonth` is the metered usage example (see
// workers/api/db/schema/usage-counters.ts). Every gate reads from PLANS.
//
...
export const PLANS: Record<PlanId, PlanLimits> = {
  free: { maxFacilities: 3, apiCallsPerMonth: 100, webhooks: false },
  pro: { maxFacilities: 25, apiCallsPerMonth: 5_000, webhooks: true },
  business: { maxFacilities: 999, apiCallsPerMonth: 50_000, webhooks: true },
};
